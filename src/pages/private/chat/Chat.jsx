...
//     error: studentsError,
//     getStudentsByClass,
//     selectedStudents: hookSelectedStudents,
...
//   // Load subjects and students when component mounts
//   useEffect(() => {
//     if (selectedClass?.id) {
//       getSubjects();
//       getStudentsByClass(selectedClass.id);
//     }
//   }, [selectedClass, getSubjects, getStudentsByClass]);
...
//                     <span className="text-xs text-gray-500">{hookSelectedStudents.length} selected</span>
//                   </div>
...
//                         const isSelected = hookSelectedStudents.some(s => s.id === student.id);
//                         const canSelect = hookSelectedStudents.length < 2 || isSelected;
...
//                 <div className="p-4">
//                   <div className="flex items-center justify-between mb-4">
//                     <h3 className="font-semibold text-gray-900">Subjects & Files</h3>
...
//                       <p className="text-xs">Create subjects to attach files</p>
//                     </div>
//                   ) : (
//                     <div className="space-y-2">
...
//                                     {subject.files.length} file(s) attached
//                                   </div>
//                                 )}
//                               </div>
//                               {isSelected && (
...
//         <div className="p-6">
//           {/* Context Preview */}
//           {(hookSelectedStudents.length > 0 || selectedSubjects.length > 0) && (
//             <div className="mb-4 p-4 bg-slate-50/80 rounded-2xl border border-slate-200/50">
//               <div className="flex items-center justify-between mb-3">
//                 <h4 className="text-sm font-medium text-slate-700">Selected Context</h4>
//                 <button
//                   onClick={() => {
//                     clearStudentSelection();
//                     clearSubjectSelection();
...
//                 <div className="mb-3">
//                   <div className="text-xs text-slate-600 mb-2">Subjects & Files:</div>
//                   <div className="flex flex-wrap gap-2">
//                     {selectedSubjects.map((subject) => (
//                       <div key={subject.id} className="bg-blue-100 text-blue-800 px-2 py-1 rounded-lg text-xs flex items-center space-x-1">
//                         <BookOpen size={12} />
...
//               {hookSelectedStudents.length > 0 && (
//                 <div>
//                   <div className="text-xs text-slate-600 mb-2">Students:</div>
//                   <div className="flex flex-wrap gap-2">
//                     {hookSelectedStudents.slice(0, 2).map((student) => (
//                       <div key={student.id} className="bg-green-100 text-green-800 px-2 py-1 rounded-lg text-xs flex items-center space-x-1">
//                         <User size={12} />
...
//                       </div>
//                     ))}
//                     {hookSelectedStudents.length > 2 && (
//                       <div className="bg-green-100 text-green-800 px-2 py-1 rounded-lg text-xs">
//                         +{hookSelectedStudents.length - 2} more
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                 className="w-full shadow px-6 py-4 pr-12 bg-white border focus:ring-1 focus:ring-slate-300 focus:outline-none border-slate-200/50 rounded-2xl resize-none min-h-[56px] max-h-32"
//                 rows={1}
...
//           <div className="mx-6 mb-4 bg-white border border-gray-200 rounded-lg shadow-lg">
//             <div className="flex items-center justify-between p-4 border-b border-gray-200">
//               <h3 className="text-sm font-semibold text-gray-900">Select Context</h3>
//               <button
...
//                 <div>
//                   <div className="flex items-center justify-between mb-3">
//                     <h4 className="text-sm font-medium text-gray-700">Subjects & Files</h4>
...
//                       <p className="text-xs">No subjects available</p>
//                     </div>
//                   ) : (
...
//                     <span className="text-xs text-gray-500">
//                       {hookSelectedStudents.length}/2 selected
//                     </span>
//                   </div>
...
//                       <p className="text-xs">No students available</p>
//                     </div>
//                   ) : (
//                     <div className="space-y-2 max-h-32 overflow-y-auto">
//                       {students.map((student) => {
...
//                 <div className="text-xs text-gray-500">
//                   {selectedSubjects.length} subjects, {hookSelectedStudents.length} students selected
//                 </div>
//                 <button
//                   onClick={() => {
//                     clearSubjectSelection();
